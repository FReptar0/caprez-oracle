      ...
      <div class="container-fluid pb-3">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <li><a class="dropdown-item" href="ServletOfertas?accion=listar-Offer">Ver ofertas</a></li>
              <li><a class="dropdown-item" href="ServletOfertas?accion=agregar">Agregar ofertas</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
          ...
          <li class="navbar-item">
            <a href="logout" class="nav-link" id="home" role="button">Cerrar sesi&oacute;n <svg
