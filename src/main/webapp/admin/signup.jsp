        ...
        <div class="container">
            ...
            <main class="form-signin w-100 m-auto">
                <form action="" method="post">
                    ...
                    <h1 class="h3 mb-3 fw-normal">Registrar nuevo administrador</h1>

                    <div class="form-floating">
                        <input type="text" class="form-control" name="name" id="floatingInput" placeholder="Juan Perez">
                    ...
                    <div class="form-floating">
                        <input type="password" class="form-control" id="floatingPassword" placeholder="Password">
                        <label for="floatingPassword">Confirmar Contrase&ntilde;a</label>
                    </div>
